...
namespace WebApiSample.Controllers
{
    ...
    public class ValuesController : Controller
    {
        ...
        //    List<AddsHistory> Ad = Seeder.lstAddsHistory.Where(kvp => kvp.ID == id).ToList<AddsHistory>();
        //    //rm.AdId = Seeder.lstAdds[0].AdId;
        ...
        //    List<AddsHistory> Ad = Seeder.lstAddsHistory.Where(kvp => kvp.Region == Region).ToList<AddsHistory>();
        //    //rm.AdId = Seeder.lstAdds[0].AgeGroup;
        ...
        //    List<AddsHistory> ahl = Seeder.lstAddsHistory.Where(kvp => kvp.Region == Region).ToList<AddsHistory>();
